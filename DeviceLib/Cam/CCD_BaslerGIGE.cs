        ...
        public bool OneShot()
        {
            ...
            try
            {
                ...
                //{
                   ...
                   // m_Cam.StreamGrabber.Start(1, GrabStrategy.LatestImages, GrabLoop.ProvidedByStreamGrabber);                 
                    return true;
                //}
            }
            catch (Exception e)
        ...
        public  bool ContinueGrab()
        {
            ...
            try
            {
                ...
                //{
                   ...
                   // m_Cam.StreamGrabber.Start(GrabStrategy.LatestImages, GrabLoop.ProvidedByStreamGrabber);             
                    return true;
                //}
            }
            catch (Exception e)
