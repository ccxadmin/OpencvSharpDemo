...
namespace DeviceLib.Cam
{
    public class HKCam :  Icam
    {
        ...
        MyCamera.MV_CC_DEVICE_INFO_LIST m_pDeviceList = new MyCamera.MV_CC_DEVICE_INFO_LIST(); //相机列表
        private MyCamera m_pMyCamera = new MyCamera();   //相机句柄
        ...
        public bool OpenCam(int camIndex, ref string msg)
        {
            ...
            //d_stucamInfo.imgHeight = (int)stParam.nCurValue;
            ...
            //d_stucamInfo.imgWidth = (int)stParam.nCurValue;
